      ...
      >
        ...
        <Box sx={{ textAlign: "justify", mt: 2 }}>
          <Typography variant="body1">
            ...
            (PIA) is an instrument for assessing the potential impacts on
            privacy of a process, information system, program, software module,
            device or other initiative which processes personal information and
            sensitive information in consultation with stakeholders, for taking
            actions as necessary to treat, mitigate and avoid privacy risk.
          </Typography>
          <Typography variant="body1" sx={{ mt: 2 }}>
            ...
            project has been deployed. Initiatives vary substantially in scale
            and impact.
          </Typography>
          <Typography variant="body1" sx={{ mt: 2 }}>
